...
export function DashboardScreen() {
    ...
    const [rankingProducts, setRankingProducts] = useState <{ product_id: string; name: string; total_added: number }[]>([]);
    const [highRotationProducts, setHighRotationProducts] = useState< { product_id: string; name: string; total_movement: number }[]>([]);
    const [noMovementProducts, setNoMovementProducts] = useState<{ product_id: string; name: string; last_movement: string | null }[]>([]);
