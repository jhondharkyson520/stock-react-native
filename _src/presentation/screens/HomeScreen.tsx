...
export default function HomeScreen() {
  ...
  return (
    <Container>
      ...
      <TouchableOpacity onPress={() => navigation.navigate("StockListScreen")}>
        <Text>Controle de estoque detalhado</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => navigation.navigate("StockExitScreen")}>
